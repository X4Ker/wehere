...
public class MainActivity extends AppCompatActivity {
    ...
    String[] cities = {"Eat", "Sport", "Art", "Music/Films", "Science", "Education", "Rest", "Fashion/Clothes"};
    TextView selection;
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    ...
                    //   loadFragment(ForYouFragment.newInstance());
                    return true;
                case R.id.navigation_dashboard:
                    Intent intent_FY = new Intent(MainActivity.this, ForYouActivity.class);
                    startActivity(intent_FY);
                 //   loadFragment(ForYouFragment.newInstance());
                    return true;
